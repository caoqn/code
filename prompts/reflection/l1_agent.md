...
- "A teammate forgot a verification step" → do not record it in L1; stable
...
- Focus on **your own behavior** — do not write teammate observations or
  collaboration procedures into your own patches or skills
